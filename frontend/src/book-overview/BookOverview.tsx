...
import {books} from "../my-books/books";
...
class BookOverview extends Component<Props, IState> {
  constructor(props: Props) {
    super(props);
    this.state = {
      book: books.find(book => book.id === +this.props?.match?.params?.id) as Book,
      favouriteIds: []
    };
              ...
              <div className="pageContent">
                ...
                <div className="row justify-content-center mt-4">
                  <div className="col-8">
                    ...
                    <strong>{this.state.book.isFavourite ?
                        (<a href={"/#"} onClick={(e) => {
                         e.preventDefault();
                       ...
                       }}>Remove this book from my favourite</a>) :
                        (<a href={"/#"} onClick={(e) => {
                          e.preventDefault();
                          const currentBook = this.state.book;
